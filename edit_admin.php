...
if(isset($_POST['submit'])) {
    ...
    $sql = "UPDATE admin_account SET full_name='$full_name', username='$username', email='$email', password='$password' WHERE id_admin='$id_admin'";
...
if(isset($_GET['id_admin'])) {
    ...
    $sql = "SELECT * FROM admin_account WHERE id_admin='$id_admin'";
